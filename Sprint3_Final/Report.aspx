...
opacity: 0.9; /* CSS3 */">
                    ...
                    <div>
                        ...
                        <table cellpadding="5" style="width: 1080px" >
                            ...
                            <tr>
                                <td>
                                    <table style="margin-left:20%;" cellpadding="4">
                                        <tr align="center">
                                            <td>
                ...
                <div style="margin-left:10%; margin-top:5%">
                        <asp:GridView ID="GridView1" runat="server" Width="1080px"
                            ...
                            AutoGenerateColumns="False" DataKeyNames="house_id" DataSourceID="SqlDataSource1" OnRowCommand="GridView1_RowCommand" AllowSorting="True" EnableSortingAndPagingCallbacks="False" AllowPaging="True" PageSize="5">
                            <Columns>
